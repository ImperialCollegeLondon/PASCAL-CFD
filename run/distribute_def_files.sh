...
for case_number in {2..15}; do
    ...
    source_file="./def_files_for_distribution/${case_name}_HPC.def"
    destination_directory="./samples/${case_name}"
    ...
    echo "File ${case_name}_HPC.def moved to $destination_directory"
done